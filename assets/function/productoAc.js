...
function renderProducto() {
    ...
    const productoEncontrado = productosAc.find(p => p.id == producto);
    if (productoEncontrado) {
        ...
        document.getElementById("imagen-principal-Ac").src = productoEncontrado.url;
...
function cambiarImagen1() {
    ...
    var ImgPrin = document.getElementById("imagen-principal-Ac");
