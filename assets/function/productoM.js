...
function renderProducto() {
    ...
    const productoEncontrado = productosM.find(p => p.id == producto);
    if (productoEncontrado) {
        ...
        document.getElementById("imagen-principal-M").src = productoEncontrado.url;
...
function cambiarImagen1() {
    ...
    var ImgPrin = document.getElementById("imagen-principal-M");
